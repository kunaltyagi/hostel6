<?php
	...
	$breakfast1[0] = "Methi Paratha, Tomato Sauce, curd, pickle, moong, BBJ, Tea/coffee/milk, Boiled egg/Bhurgi, fruit";
	$breakfast1[1] = "upma, chutney, boiled groundnuts, BBJ, Tea/coffee/milk, Boiled egg/Omelette, fruit ";
	$breakfast1[2] = "Poha+sheera+shev, matki usal, BBJ, Tea/coffee/milk, Boiled egg/Omelette, fruit ";
	$breakfast1[3] = "onion uthappam sambar, chutney, sweet corn, BBJ, Tea/coffee/milk, Boiled egg/Omelette, fruit";
	$breakfast1[4] = "Alu paratha, boiled groundnuts, BBJ, Tea/coffee/milk, Boiled egg/Omelette, fruit";
	$breakfast1[5] = "puri bhaji, sambar, chutney, white chowli sprouted, BBJ, Tea/coffee/milk, Boiled egg/Omelette	, fruit";
	$breakfast1[6] = "Paneer paratha, sprouted moong, BBJ, Tea/coffee/milk, Boiled egg/Bhurji, fruit";
