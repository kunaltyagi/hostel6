...
<h1>Find your Ip</h1>
<p>Please enter your room Number : <input type="text" maxlength="3" id="roomInput" size="5" style="padding:5px 10px 5px 10px; text-align:center; background-color:#ffffff; color:#333; font-weight:bolder;" onKeyUp="ipaddress(this.value)" /></p>
</div>
