...
<!--Tech Council-->
<h2>Tech Council Admin Login</h2>
<form action="admin/tech/index.php" method="post">
LDAP Id&nbsp; <input type="text" name="name" /><br>
Password <input type="password" name="password" />
<input type="submit" value="Login" />
</form><br/>
...
<span class="blu"><b>Anshul Mehra</b></span><br/>
<span class="blu">Mobile Number: </span>+91 9967452914<br/>
<span class="blu">Email Id: </span>anshulmehra94@gmail.com</p>
</div>
