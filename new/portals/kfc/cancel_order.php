...
if (mysql_num_rows($delete)) {
	...
	<tr>  
		...
		<th scope="col" id="...">Potato Krisper &nbsp;&nbsp;</th>
		<th scope="col" id="...">Chicken snackers &nbsp;&nbsp;</th>
		<th scope="col" id="...">Popcorn chi. Regular &nbsp;&nbsp;</th>  
		<th scope="col" id="...">Popcorn Chi. large &nbsp;&nbsp; </th>
        <th scope="col" id="...">Hot wings(5 pcs) &nbsp;&nbsp; </th>
        <th scope="col" id="...">Chicken rice bowl &nbsp;&nbsp; </th>
        <th scope="col" id="...">veg rice bowl &nbsp;&nbsp; </th>
