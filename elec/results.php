...
if($_SERVER[REMOTE_ADDR]!='10.6.72.32' && $_SERVER[REMOTE_ADDR]!='10.6.14.5' && $_SERVER[REMOTE_ADDR]!='10.6.14.1' && $_SERVER[REMOTE_ADDR]!='10.6.14.2' && $_SERVER[REMOTE_ADDR]!='10.6.14.3' && $_SERVER[REMOTE_ADDR]!='10.6.14.4' && $_SERVER[REMOTE_ADDR]!='10.6.14.6' && $_SERVER[REMOTE_ADDR]!='10.6.14.7' && $_SERVER[REMOTE_ADDR]!='10.6.14.8'  && $_SERVER[REMOTE_ADDR]!='10.6.14.9') die("You are not allowed to use this page.");//change here

if($_POST['password']=="anshulmehra"){
