...
{//change here
	if(isset($_POST['submission']))
	{
		...
		$can[16] = $_POST['hrishikesh'];
		$can[17] = $_POST['jaideep'];
		$can[18] = $_POST['mistry'];
		$can[19] = $_POST['akshay'];
...
?>	<h1>Please read the instructions carefully before voting</h1>
	...
	<div class="post" maxyes="3">
		...
		<?php printcand("Amit Raghuwanshi","img/ankur.jpg","raghuvanshi"); ?>
	...
	<div class="post" maxyes="1">
		...
		<?php printcand("Tanmay Shrivastava","img/abhirath.jpg","tanmay"); ?>
	</div>
	<div style="clear:both"></div>
	<br>
	<div class="post" maxyes="1">
		<h3>Secretary for Cultural Affairs - Dance</h3>
		<?php printcand("Piyush Kumar","img/piyush.jpg","piyush"); ?>
	</div>
	<div style="clear:both"></div>
	<br>
	<div class="post" maxyes="4">
		...
		<?php printcand("Parth Dalal","img/parth.jpg","parth"); ?>
		<?php printcand("DEEPAK KUMAR","img/deepakk.jpg","deepakk"); ?>
		<?php printcand("Hrishikesh Kulkarni","img/hrishikesh.jpg","hrishikesh"); ?>
		<?php printcand("Jaideep Poonia","img/jaideep.jpg","jaideep"); ?>
	</div>
	<div style="clear:both"></div>
	<br>
	<div class="post" maxyes="2">
		...
		<?php printcand("Akshay Jain","img/siddhant.jpg","akshay"); ?>
		<?php printcand("Ankur Kaushik","img/sireesh.jpg","kaushik"); ?>
		<?php printcand("Dipesh Chauhan","img/sireesh.jpg","dipesh"); ?>
	</div>
	<div style="clear:both"></div>
	<br>
	<div class="post" maxyes="1">
	...
	<div class="post" maxyes="3">
		...
		<?php printcand("Shubham Bhartiya","img/bhargav.jpg","bhartiya"); ?>
